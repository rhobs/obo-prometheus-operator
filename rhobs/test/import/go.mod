...
require (
	github.com/rhobs/obo-prometheus-operator v0.82.1-rhobs1
	github.com/rhobs/obo-prometheus-operator/pkg/apis/monitoring v0.82.1-rhobs1
	github.com/rhobs/obo-prometheus-operator/pkg/client v0.82.1-rhobs1
)
