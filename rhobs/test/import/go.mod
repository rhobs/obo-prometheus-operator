...
require (
	github.com/rhobs/obo-prometheus-operator v0.80.0-rhobs1
	github.com/rhobs/obo-prometheus-operator/pkg/apis/monitoring v0.80.0-rhobs1
	github.com/rhobs/obo-prometheus-operator/pkg/client v0.80.0-rhobs1
)
