...
require (
	github.com/rhobs/obo-prometheus-operator v0.89.0-rhobs2
	github.com/rhobs/obo-prometheus-operator/pkg/apis/monitoring v0.89.0-rhobs2
	github.com/rhobs/obo-prometheus-operator/pkg/client v0.89.0-rhobs2
)
