...
import (
	...
	apismonitoringv1beta1 "github.com/rhobs/obo-prometheus-operator/pkg/apis/monitoring/v1beta1"
	internalinterfaces "github.com/rhobs/obo-prometheus-operator/pkg/client/informers/externalversions/internalinterfaces"
	monitoringv1beta1 "github.com/rhobs/obo-prometheus-operator/pkg/client/listers/monitoring/v1beta1"
...
func NewAlertmanagerConfigInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
	gvr := schema.GroupVersionResource{Group: "monitoring.rhobs", Version: "v1beta1", Resource: "alertmanagerconfigs"}
