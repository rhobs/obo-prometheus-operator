...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DockerSwarmFilter) DeepCopyInto(out *DockerSwarmFilter) {
	*out = *in
	if in.Values != nil {
		in, out := &in.Values, &out.Values
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DockerSwarmFilter.
func (in *DockerSwarmFilter) DeepCopy() *DockerSwarmFilter {
	if in == nil {
		return nil
	}
	out := new(DockerSwarmFilter)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DockerSwarmSDConfig) DeepCopyInto(out *DockerSwarmSDConfig) {
	*out = *in
	...
	if in.Filters != nil {
		in, out := &in.Filters, &out.Filters
		*out = make([]DockerSwarmFilter, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
