...
for n in "prometheus-operator" "prometheus-config-reloader" "admission-webhook"; do podman save --quiet -o tmp/$n.tar "quay.io/rhobs/obo-$n:$(git rev-parse --short HEAD)"; kind load image-archive tmp/$n.tar; done
```
